...
def diffusion_ftcs(nspace, ntime, tau_rel, args):
    ...
    for istep in range(ntime):
        ...
        # We do this at every time step since the problem does not specify to plot at a smaller time domain
...
# Time in mesh plot of figure 6.8 goes up to ~0.06s
...
ct_68 = plt.contour(tplot_68, xplot_68, ttplot_68, levels)
